...
class PlanSearchTestCase(TestCase):
    ...
    def test_invalid_plan_code_with_ddd_filter(self):
        querystring = 'ddds=[21]&plan_code=Orelhao21'
        path = self.url + querystring
    ...
    def test_valid_plan_code_with_ddd_filter(self):
        querystring = 'ddds=[21]&plan_code=TimControle20gb200'
        path = self.url + querystring
